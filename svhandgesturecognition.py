...
while(True):
	...
	cv2.imshow('hsv',hsv)
	thresh=cv2.inRange(hsv,(0,81,53),(162,255,166))
	cv2.imshow("threshed",thresh)
	p=frame.shape
	cv2.line(frame,(p[1]/3,0),(p[1]/3,p[0]),(0,0,0),5) # for left line
	cv2.line(frame,(2*p[1]/3,0),(2*p[1]/3,p[0]),(0,0,0),5)# for right line
	cv2.line(frame,(p[1]/3,p[0]/2),(2*p[1]/3,p[0]/2),(0,0,0),5) # for middle line
	max_area=0
